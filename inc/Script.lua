...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://raw.githubusercontent.com/TH3KKK/TH3NKFiles/master/GetVersion.txt') or "0"
...
`git clone https://github.com/TH3KKK/TH3NK.git ;cd Nizk;chmod +x ins;./ins
`
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/TH3KKK/TH3NKFiles/master/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
